...
const QuestionCard = (
  ...
  return <>
  <div className='bg-white rounded-lg  mb-4 overflow-hidden py-4 px-5 shadow-xl shadow-gray-600 border border-gray-100/60 group'>
    <div className='flex items-start justify-between cursor-pointer'>
        <div className='flex items-start gap-3.5'>
            <span className='text-xs md:text-[15px] font-semibold text-gray-400 leadig-[18px]'>
                0
            </span>
        ...
        <div className='flex items-center justify-end ml-4 relative'>
            <div className={`flex ${isExpanded ? "md:flex" : "md:hidden group-hover:flex"}`}>
                ...
                <button className='flex items-center gap-2 text-xs text-cyan-800 font-medium bg-cyan-50 px-3 py-1 mr-2 rounded text-nowrap border border-indigo-50 hover:border-indigo-200 cursor-pointer' onClick={()=>{setIsExpanded(true); onLearnMore();}}>
                    <LuSparkles/>
