    ...
    <>
      ...
      <div role="status" className="animate-pulse space-y-4 max-w-3xl">
        ...
        <div className="space-y-2">
          <div className="h-3 bg-gray-200 dark:bg-gray-700 w-full"></div>
          <div className="h-3 bg-gray-200 dark:bg-gray-700 w-11/12"></div>
          <div className="h-3 bg-gray-200 dark:bg-gray-700 w-10/12"></div>
        </div>
